...
//guest -id, name , address, contact_no ,vist_date

//addGuest updateGuest deleteGuest readGuest listGuest

const db_file="data.json";

const addGuest =(name,address,contact_no,vist_date)=>{
...
const updateGuest =(id,name,address,contact_no,vist_date)=>{
    const guests = loadGuests();
    ...
    if (guestIndex!=-1){
        ...
        guest.vist_date = vist_date ? vist_date:guest.vist_date;
